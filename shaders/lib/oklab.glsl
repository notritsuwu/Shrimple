vec3 LinearToLab(const in vec3 linear) {
...
//        -0.0040720468,  0.4505937099, -0.8086757660);
    ...
    return pow(kCONEtoLMS * linear, vec3(1.0/3.0));
//    vec3 lms = kCONEtoLMS * linear;
//    return invA * (sign(lms) * pow(abs(lms), vec3(1.0/3.0)));
}

vec3 LabToLinear(const in vec3 lms) {
